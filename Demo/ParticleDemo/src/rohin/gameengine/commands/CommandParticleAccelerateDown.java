// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Name:    CommandParticleAccelerateDown
// Version: 1.0
// Date:    2014
...
// Description:
//
//   Finds the particle with user control and sets accelerateDown to true.
//
// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public class CommandParticleAccelerateDown implements ICommand
{
    // ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //
    // Fields
    ...
    public CommandParticleAccelerateDown ( EngineParticleSimulator engine )
    {
        this.engine = engine;
    }
    ...
    public void execute ()
    {
        ...
        for ( ECSEntity entity : this.engine.getEntities ().values () )
        {
            if ( entity.hasComponents ( userControlToken ) )
            {
                ...
                userControl.accelerateDown = true;
                break;
            }
        }
    }
