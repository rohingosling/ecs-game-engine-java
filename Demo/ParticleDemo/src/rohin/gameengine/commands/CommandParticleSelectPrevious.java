// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Name:    CommandParticleSelectPrevious
// Version: 1.0
// Date:    2014
...
// Description:
//
//   Selects the previous particle in the simulation. If no particle is
//   currently selected, selects the first particle. Wraps around from first
//   to last.
//
//   On selection:
...
public class CommandParticleSelectPrevious implements ICommand
{
    // ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //
    // Fields
    ...
    public CommandParticleSelectPrevious ( EngineParticleSimulator engine )
    {
        this.engine = engine;
    }
    ...
    public void execute ()
    {
        ...
        // Select previous particle (wraps around).

        int prevIndex;

        if ( currentIndex <= 0 )
        {
            prevIndex = particles.size () - 1;
        }
        else
        {
        ...
        ECSEntity prev = particles.get ( prevIndex );
        ...
        prev.addComponent ( Constants.COMPONENT_USER_CONTROL, userControl );

        // Change sprite to selected sprite.

        ComponentResourceSprite sprite = (ComponentResourceSprite) prev.getComponent ( Constants.COMPONENT_RESOURCE_SPRITE );
        ...
        ComponentTranslationHistory trail = (ComponentTranslationHistory) prev.getComponent ( Constants.COMPONENT_TRANSLATION_HISTORY );
